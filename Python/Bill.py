...
#MD NAJEEB UDDIN
        ...
        F1.place(x=0,y=80,relwidth=1)#MD NAJEEB
        ...
        cname_txt=Entry(F1,width=20,textvariable=self.c_name,font="arial 10",bd=7,relief=SUNKEN).grid(row=0,column=1,padx=5,pady=10)#MD NAJEEB
        ...
        c_bill_txt=Entry(F1,width=20,textvariable=self.search_bill,font="arial 10",bd=7,relief=SUNKEN).grid(row=0,column=5,padx=5,pady=10)#MD NAJEEB

        bill_btn=Button(F1,text="Search",command=self.find_bill,bg="#03C04A",fg="white",width=10,bd=7,font="arial 12 bold").grid(row=0,column=6,pady=10,padx=40)#MD NAJEEB
        ...
        sprite_txt=Entry(F2,width=10,textvariable=self.sprite,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)#NAJEEB
        ...
        thumbsup_txt=Entry(F2,width=10,textvariable=self.thumbsup,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)#NJ
        ...
        coco_cola_txt=Entry(F2,width=10,textvariable=self.coco_cola,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        sveen_Up_txt=Entry(F2,width=10,textvariable=self.sveen_Up,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        Dukes_txt=Entry(F2,width=10,textvariable=self.Dukes,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        mirinda_txt=Entry(F2,width=10,textvariable=self.mirinda,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        lays_lbl1=Label(F3,text="Lays",font=("times new roman",16,"bold"),bg=bg_color,fg="#003151").grid(row=0,column=0,padx=10,pady=10,sticky="w")#MD NAJEEB
        ...
        doritos_txt=Entry(F3,width=10,textvariable=self.doritos,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        peppy_txt=Entry(F3,width=10,textvariable=self.peppy,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=3,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        wheels_txt=Entry(F3,width=10,textvariable=self.wheels,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10)#MD NAjeeb
        
        #========Chocolate============

        F4=LabelFrame(self.root,text="Chocolate",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),fg="#191970",bg=bg_color)
        F4.place(x=670,y=180,width=325,height=380)#MD NAJEEB
        ...
        silk_txt=Entry(F4,width=10,textvariable=self.silk,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        toblerone_txt=Entry(F4,width=10,textvariable=self.toblerone,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        kitkat_txt=Entry(F4,width=10,textvariable=self.kitkat,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        star_txt=Entry(F4,width=10,textvariable=self.star,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        fuse_txt=Entry(F4,width=10,textvariable=self.fuse,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10)#MD NAJEEB
        ...
        scrol_y=Scrollbar(F5,orient=VERTICAL)#MD NAJEEB
        self.txtarea=Text(F5,yscrollcommand=scrol_y.set)#MD NAJEEB
        scrol_y.pack(side=RIGHT,fill=Y)#MD NAJEEB
        scrol_y.config(command=self.txtarea.yview)#MD NAJEEB
        self.txtarea.pack(fill=BOTH,expand=1)#MD NAJEEB
#MD NAJEEB
        #=======Button=======
        F6=LabelFrame(self.root,text="Bill Menu",bd=10,relief=GROOVE,font=("times new roman",15,"bold"),fg="#191970",bg=bg_color)
        F6.place(x=0,y=560,relwidth=1,height=140)#MD NAJEEB
        ...
        a1_txt=Entry(F6,width=18,textvariable=self.juice_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=0,column=1,padx=10,pady=1)#MD NAJEEB
        ...
        a2_txt=Entry(F6,width=18,textvariable=self.chips_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=1)#MD NAJEEB
        ...
        a3_txt=Entry(F6,width=18,textvariable=self.chocolate_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=2,column=1,padx=10,pady=1)#MD NAJEEB

        
        b1_lbl1=Label(F6,text="Juice Tax",bg=bg_color,fg="#003151",font=("times new roman",14,"bold")).grid(row=0,column=2,padx=20,pady=1,sticky="w")#MD NAJEEB
        b1_txt=Entry(F6,width=18,textvariable=self.juice_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=0,column=3,padx=10,pady=1)#MD NAJEEB
        #MD NAJEEB
        ...
        b2_txt=Entry(F6,width=18,textvariable=self.chips_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=1,column=3,padx=10,pady=1)#MD NAJEEB
        ...
        b3_txt=Entry(F6,width=18,textvariable=self.chocolate_tax,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=2,column=3,padx=10,pady=1)#MD NAJEEB
...
#MD NAJEEB
        ...
        txtscroll.grid(row=0, column=0, columnspan=4)#MD NAJEEB
        display()

    def total(self):#MD NAJEEB
        self.lays_price=10
        self.doritos_price=50
        self.pringles_price=90#MD NAJEEB
        self.peppy_price=90
        ...
        self.c_p_p=(self.pringles.get()*self.pringles_price)#MD NAJEEB
        self.c_pe_p=(self.peppy.get()*self.peppy_price)
        self.c_ku_p=(self.kurkure.get()*self.kurkure_price)
        self.c_w_p=(self.wheels.get()*self.wheels_price)#MD NAJEEB
        self.total_chips_price=float(
                                self.c_l_p+
                                self.c_d_p+
                                self.c_p_p+
                                self.c_pe_p+
                                self.c_ku_p+#MD NAJEEB
                                self.c_w_p
                                )
        self.chips_price.set("Rs. "+str(self.total_chips_price))#MD NAJEEB
        self.cs_tax=round((self.total_chips_price*0.1),2)
        self.chips_tax.set("Rs. "+str(self.cs_tax))#MD NAJEEB
#MD NAJEEB
        self.sprite_price=40
        self.thumbsup_price=50#MD NAJEEB
        self.coco_cola_price=50
        self.sevenup_price=40
        self.dukes_price=50
        self.mirinda_price=40
        self.j_s_p= (self.sprite.get()*self.sprite_price)#MD NAJEEB
        self.j_t_p=(self.thumbsup.get()*self.thumbsup_price)
        self.j_c_p=(self.coco_cola.get()*self.coco_cola_price)
        self.j_sv_p=(self.sveen_Up.get()*self.sevenup_price)#MD NAJEEB
        self.j_d_p=(self.Dukes.get()*self.dukes_price)
        self.j_m_p=(self.mirinda.get()*self.mirinda_price)#MD NAJEEB
        self.total_juice_price=float(#MD NAJEEB
                                self.j_s_p+#MD NAJEEB
                                self.j_t_p+#MD NAJEEB
                                self.j_c_p+#MD NAJEEB
                                self.j_sv_p+#MD NAJEEB
                                self.j_d_p+#MD NAJEEB
                                self.j_m_p#MD NAJEEB
                                )
        self.juice_price.set("Rs. "+str(self.total_juice_price))#MD NAJEEB
        self.je_tax=round((self.total_juice_price*0.05),2)#MD NAJEEB
        self.juice_tax.set("Rs. "+str(self.je_tax))#MD NAJEEB

        self.silk_price=80#MD NAJEEB
        self.toblerone_price=50
        self.kitkat_price=40
        self.snicker_price=50#MD NAJEEB
        self.star_price=30
        self.fuse_price=20
        self.c_s_p=(self.silk.get()*self.silk_price)#MD NAJEEB
        self.c_t_p=(self.toblerone.get()*self.toblerone_price)
        self.c_k_p=(self.kitkat.get()*self.kitkat_price)
        self.c_sr_p=(self.snicker.get()*self.snicker_price)#MD NAJEEB
        self.c_st_p=(self.star.get()*self.star_price)
        self.c_f_p=(self.fuse.get()*self.fuse_price)#MD NAJEEB
        self.total_chocolate_price=float(
                                self.c_s_p+
                                self.c_t_p+#MD NAJEEB
                                self.c_k_p+#MD NAJEEB
                                self.c_sr_p+
                                self.c_st_p+#MD NAJEEB
                                self.c_f_p
                                )
        self.chocolate_price.set("Rs. "+str(self.total_chocolate_price))#MD NAJEEB
        self.ch_tax=round((self.total_chocolate_price*0.15),2)#MD NAJEEB
        self.chocolate_tax.set("Rs. "+str(self.ch_tax))
    
        self.Total_bill=float(self.total_chips_price+#MD NAJEEB
                            self.total_chocolate_price+
                            self.total_juice_price+#MD NAJEEB
                            self.cs_tax+#MD NAJEEB
                            self.je_tax+
                            self.ch_tax#MD NAJEEB
                            )   
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END,f"\n CUSTOMER NAME : {self.c_name.get()}")#MD NAJEEB
        self.txtarea.insert(END,f"\n PHONE NUMBER : {self.c_phon.get()}")
        self.txtarea.insert(END,f"\n===========================================================")
        self.txtarea.insert(END,f"\n PRODUCTS\t\tQUANTITY\t\tPRICE\t\tTOTAL PRICE")#MD NAJEEB
        self.txtarea.insert(END,f"\n===========================================================")
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phon.get()=="":
            messagebox.showerror("Error","Customer Detais are Required")
             ...
             messagebox.showerror("Error","Products Not selected")#MD NAJEEB
        else:
            self.welcome_bill()

            #====juice bill generate======
            if self.sprite.get()!=0:
                self.txtarea.insert(END,f"\n Sprite\t\t{self.sprite.get()}\t\t{self.sprite_price}\t\t{self.j_s_p}")#MD NAJEEB
            ...
            if self.kurkure.get()!=0:
                self.txtarea.insert(END,f"\n Kurkure\t\t{self.kurkure.get()}\t\t{self.kurkure_price}\t\t{self.c_ku_p}")#MD NAJEEB
            if self.wheels.get()!=0:
                self.txtarea.insert(END,f"\n Wheels\t\t{self.wheels.get()}\t\t{self.wheels_price}\t\t{self.c_w_p}")#MD NAJEEB

            #=========chocolate bill generate=====
            if self.silk.get()!=0:
                self.txtarea.insert(END,f"\n DairyMilk Silk\t\t{self.silk.get()}\t\t{self.silk_price}\t\t{self.c_s_p}")#MD NAJEEB
            if self.toblerone.get()!=0:
                self.txtarea.insert(END,f"\n Toblerone\t\t{self.toblerone.get()}\t\t{self.toblerone_price}\t\t{self.c_t_p}")#MD NAJEEB
            if self.kitkat.get()!=0:
                self.txtarea.insert(END,f"\n Kit Kat\t\t{self.kitkat.get()}\t\t{self.kitkat_price}\t\t{self.c_k_p}")#MD NAJEEB
            if self.snicker.get()!=0:
                self.txtarea.insert(END,f"\n Snicker\t\t{self.snicker.get()}\t\t{self.snicker_price}\t\t{self.c_sr_p}")#MD NAJEEB
            if self.star.get()!=0:
                self.txtarea.insert(END,f"\n 5 Star\t\t{self.star.get()}\t\t{self.star_price}\t\t{self.c_st_p}")#MD NAJEEB
            if self.fuse.get()!=0:
                self.txtarea.insert(END,f"\n Fuse\t\t{self.fuse.get()}\t\t{self.fuse_price}\t\t{self.c_f_p}")#MD NAJEEB
            
            self.txtarea.insert(END,f"\n-----------------------------------------------------------")
            if self.juice_tax.get()!="Rs. 0.0":#MD NAJEEB
                self.txtarea.insert(END,f"\n Juice Tax\t\t\t\t\t\t{self.juice_tax.get()}")
            if self.chips_tax.get()!="Rs. 0.0":#MD NAJEEB
                self.txtarea.insert(END,f"\n Chips Tax\t\t\t\t\t\t{self.chips_tax.get()}")
            if self.chocolate_tax.get()!="Rs. 0.0":#MD NAJEEB
                self.txtarea.insert(END,f"\n chocolate Tax\t\t\t\t\t\t{self.chocolate_tax.get()}")#MD NAJEEB
            
            self.txtarea.insert(END,f"\n TOTAL BILL\t\t\t\t\t\tRs. {str(self.Total_bill)}")
            self.txtarea.insert(END,f"\n-----------------------------------------------------------")
            self.save_bill()
    def save_bill(self):
        op=messagebox.askyesno("Save Bill","Do you want to save the Bill?")#MD NAJEEB
        if op>0:
            self.bill_data=self.txtarea.get('1.0',END)
            f1=open("D:\\Python_code\\Python_Project\\bills"+str(self.bill.get())+".txt","w")#MD NAJEEB
            f1.write(self.bill_data)
            f1.close()
            messagebox.showinfo("Saved",f"Bill No :{self.bill.get()} Saved Succeddfully")#MD NAJEEB
        else:#MD NAJEEB
            return
    def find_bill(self):#MD NAJEEB
        present="no"
        for i in os.listdir("D:\\Python_code\\Python_Project\\bills/"):
            if i.split('.')[0]==self.search_bill.get():#MD NAJEEB
                f1=open(f"D:\\Python_code\\Python_Project\\bills/{i}","r")
                self.txtarea.delete('1.0',END)
                for d in f1:
                    self.txtarea.insert(END,d)
                f1.close()
                present="yes"#MD NAJEEB
        if present=="no":
